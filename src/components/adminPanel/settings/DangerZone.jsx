...
//         <>
//             <motion.div
//                 className='bg-blue-900 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-6 border border-red-700 mb-3'
...
//                 </p>
//                 <button
//                     className='bg-green-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded transition duration-300'
