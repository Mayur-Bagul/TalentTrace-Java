...
//     { name: "Job Listing", icon: ShoppingBag, color: "#8B5CF6", href: "/admin/products" },
...
// import React, { useEffect, useState } from "react";
// import { BarChart2, Settings, ShoppingBag, TrendingUp, Users, Menu } from "lucide-react";
// import { AnimatePresence, motion } from "framer-motion";
// import { Link } from "react-router-dom";
...
//   return (
//     <motion.div
//   className={`fixed top-0 left-0 h-full z-50 transition-all duration-300 ease-in-out ${isSidebarOpen ? 'w-64' : 'w-20'}`}
//   animate={{ width: isSidebarOpen ? 220 : 80 }}
//   style={{ margin: 0 }}
// >
//   <div className="h-full bg-gray-900 bg-opacity-60 backdrop-blur-md p-4 flex flex-col border-r border-gray-800">
//     <motion.button
//       whileHover={{ scale: 1.2 }}
//       whileTap={{ scale: 0.8 }}
//       onClick={() => setIsSidebarOpen(!isSidebarOpen)}
